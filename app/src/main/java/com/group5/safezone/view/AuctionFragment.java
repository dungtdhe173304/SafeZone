...
public class AuctionFragment extends Fragment {
    ...
    private TextView etSearch; // binds to etSearch
    private Button btnSearch;  // binds to btnSearch
    private Button btnPostAuction; // binds to btnPostAuction
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_auction_fragment, container, false);
    }
    ...
    private void observeViewModel() {
        ...
        userViewModel.getCurrentUser().observe(getViewLifecycleOwner(), user -> {
            if (user != null) {
                ...
                if (tvBalancePill != null) tvBalancePill.setText(balanceText);
                if (tvHelloUser != null) tvHelloUser.setText("Chào mừng, " + (user.getUserName() != null ? user.getUserName() : "Khách") + "!");
    ...
    private void displayWelcomeMessage() {
        ...
        if (tvHelloUser != null) tvHelloUser.setText("Chào mừng, " + (userName != null ? userName : "Khách") + "!");
        if (tvBalancePill != null) tvBalancePill.setText(balanceText);
        if (ivAvatar != null) ivAvatar.setImageResource(R.drawable.ic_person);
    }
